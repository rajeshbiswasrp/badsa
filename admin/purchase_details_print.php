...
<td width="70" class="style2"><img src="<?php echo "logo1/".$sname_logo['sch_img']; ?>" width="100" height="30"/></td>
  <td width="410" class="style2"><div class="style3" style="text-align:left; margin-left:60px;">CASH MEMO</div></td>
...
<?php
$sqln="select*from ph_purchase_master where status ='1'";
...
<table width="450" border="0" align="center" cellpadding="2" cellspacing="0">
<tr>
<td class="bbottom btop"> <!--<div style="text-transform:uppercase; font-weight:bold; text-align:left; font-size:12px;"><?php //echo $rown["grn_no"];?></div>--> <div style="text-transform:uppercase; font-weight:bold; text-align:center; font-size:15px;">Purchase Details</div></td>
</tr>
</table>
...
<table width="450" border="0" align="center" cellpadding="1" cellspacing="0" style="margin-top:1px;">
  <tr>
    <td width="99" class="btop "><strong>Voucher No.  :</strong></td>
    <td width="165" class="btop"><?php echo $rown["voucher_no"];?></td>
    <td colspan="2" class="btop"><strong>Voucher Date :</strong></td>
    <td width="85" class="btop "><span class=""><?php echo $rown["voucher_date"];?></span></td>
  </tr>
  <tr>
    <td width="99" class=" "><strong>Supplier Name  :</strong></td>
    <td class=""><?php echo $rown1["sup_name"];?></td>
    <td colspan="2" class=""><strong>Invoice No.  :</strong></td>
    <td width="85" class=" "><span style="text-transform:capitalize;"><?php echo $rown["invoice_no"];?></span></td>
  </tr>
  <tr>
    <td width="99" class=" bbottom"><strong>Address  :</strong></td>
    <td colspan="4" class="bbottom "><?php echo $rown1["address"];?></td>
    </tr>
</table>
...
<?php
$c=1;
$sql="select * from ph_purchase_master where status ='1'";
$res=mysql_query($sql);
...
<?php
$sql1="select SUM(net_amt)as net_amount from ph_purchase_master where status='1'";
...
?>
 ...
 <tr>
    ...
    <td class="bright bbottom"><div align="center"></div></td>
	<!--<td class="bright bbottom"><div align="center"></div></td>-->
    <td class=" bbottom btop"><div align="center" style="font-weight:bold;"><?php echo number_format($net_amount,'2','.','');?></div></td>
  </tr>
   <!--<tr>
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center"></div></td>
...
<table width="450" border="0" align="center" cellpadding="1" cellspacing="0" style="margin-top:1px;">
  <tr>
    <td class="bbottom  bright btop desc"><div align="center"><span class="style1" style="font-weight:bold; text-transform:uppercase; font-size:11px;">TOTAL ITEMS</span></div></td>
    <td class="bbottom bright btop desc"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">TOTAL AMOUNT</span></div></td>
    <td class="bbottom  btop desc"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">TOTAL AMOUNT</span></div></td>
    <!--<td class="bbottom bright btop"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;"> C. NOTE.</span></div></td>
    <td class="bbottom bright btop"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;"> NET AMT.</span></div></td>-->
  </tr>
<?php
$sql="select * from ph_purchase_master where status ='1'";
$res=mysql_query($sql);
...
while($row=mysql_fetch_array($res))
{
$sql141="select SUM(qty)as tot_qtyy from ph_purchase_master where status='1'";
$res141=mysql_query($sql141);
while($row141=mysql_fetch_array($res141))
{
$tot_qtyy=$row141['tot_qtyy'];
}

$sql142="select SUM(total_qty_p)as tot_bbpp from ph_purchase_master where status='1'";
$res142=mysql_query($sql142);
while($row142=mysql_fetch_array($res142))
{
$tot_bbpp=$row142['tot_bbpp'];
}

$sql143="select SUM(total_rate)as total_rates from ph_purchase_master where status='1'";
$res143=mysql_query($sql143);
while($row143=mysql_fetch_array($res143))
{
$total_rates=$row143['total_rates'];
}



$sql143="select SUM(tax_amt)as vat_amtt from ph_purchase_master where status='1'";
$res143=mysql_query($sql143);
while($row1=mysql_fetch_array($res143))
{
$vat_amtt=$row1['vat_amtt'];
}
...
?>
  <tr>
    <td class="bbottom  bright "><div align="center"><?php echo $nu_rows;?></div></td>
    <td class="bbottom bright "><div align="center"><?php echo number_format ($total_rates,'2','.','');?></div></td>
    <td class="bbottom  "><div align="center"><?php echo number_format ($net_amount,'2','.','');?> </div></td>
  </tr>
</table>
