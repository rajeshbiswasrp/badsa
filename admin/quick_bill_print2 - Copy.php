...
<?php
$sqln="select*from quick_bill where voucher_no ='$voucher_no'";
...
<table width="450" border="0" align="center" cellpadding="5" cellspacing="0" style="margin-top:1px;">
 <tr valign="top">
     ...
     <td colspan="2" class="btop bbottom bright"><div align="right"><span class="style1"><strong>RATE</strong></span></div>       </td>
     ...
     <td colspan="2" class="btop bbottom "><div align="right"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Amount</span></div></td>
  </tr>
<?php
$c=1;
...
?>
  <tr>
    ...
    <td colspan="2" class="bright"><div align="right"><?php echo number_format ($row["rate"],'2','.','');?></div> </td>
...
<?php
$sql1="select SUM(tot_amt)as gro_amt from quick_bill where voucher_no ='$voucher_no'";
...
<table width="450" border="0" align="center" cellpadding="5" cellspacing="0" style="margin-top:1px;">
   <tr>
    <td colspan="4" class="btop"><div>
      <div><u><b>Amount Payable:</b></u></div>
    </div>      <div align="left"></div></td>
    <td class="bright bleft btop"><div align="center" style="font-weight:bold; text-align:right;">Net Total</div></td>
