...
<table align="center" width="750" border="0" cellpadding="2" cellspacing="0">
  <tr>
    ...
    <div align="center"><h2> HOSIERY & FANCY READY MMADE SUPPLIER </h2></div>
...
<table width="750" border="0" align="center" cellpadding="1" cellspacing="0" style="margin-top:1px;">
 <tr>
   ...
   <!--  <td width="60" class="btop bbottom bright"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Base</span></div></td>-->
     <!--<td width="60" class="btop bbottom bright"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Unit</span></div></td>-->
     ...
     <td width="53" class="btop bbottom bright"><div align="right"><span class="style1">RATE</span></div></td>
     <td width="125" class="btop bbottom bright"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Batch No.</span></div></td>
     <!--<td width="92" class="btop bbottom bright"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Exp. Date</span></div></td>-->
     <!--<td width="79" class="btop bbottom bright"><div align="center"><span style="font-weight:bold; text-transform:uppercase; font-size:11px;">Gift</span></div></td>-->
...
?>
  <tr>
    ...
    <td class="bright"><div align="center"><?php echo $row["dico_per"];?></div></td>
    <td width="53" ><div align="right"><?php echo number_format($row["gross_amt"],'2','.','') ;?></div></td>
  </tr>
<?php
$c++;
}
...
$tot_rate=$gro_amt+$v_amt;

$d_amt=$rown3["dis_amt"];
$tot_valu=$tot_rate-$d_amt;
...
<tr>
 ...
 <tr>
   ...
   <!-- <td class="bright"><div align="center"></div></td>
    ...
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center" style="font-weight:bold; text-align:right;"> VAT(<?php echo $rown["taxpm"]; ?>% +)</div></td>
    <td class=" " style="border-bottom:1px solid;"><div align="right"><?php echo number_format($v_amt,'2','.','') ;?></div></td>
  </tr>
  <tr>
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center"></div></td>
   ...
   <!-- <td class="bright"><div align="center"></div></td>
    ...
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center"></div></td>
    <td class="bright"><div align="center" style="font-weight:bold; text-align:right;">Gross Amount</div></td>
    <td class=" " ><div align="right"><?php echo number_format($tot_rate,'2','.','') ;?></div></td>
  </tr>
