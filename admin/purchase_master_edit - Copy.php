...
echo $sql="UPDATE ph_purchase_master SET voucher_date='$voucher_date',sup_id='$sup_id',batch='$batch',mrp='$mrp',ptr='$ptr',base_type='$base_type',qty='$qty',nts='$nts',dis_status='$dis_status',discount='$discount',tax_status='$tax_status',taxpm='$taxpm',total_rate='$total_rate',total_rate_p='$total_rate_p',total_qty_p='$total_qty_p',dis_amt='$dis_amt',after_dis='$after_dis',tax_amt='$tax_amt',net_amt='$net_amt',dis_amtb='$dis_amtb',after_disb='$after_disb',tax_amtb='$tax_amtb',net_amtb='$net_amtb',date='$dd' WHERE id='$id'";
...
?>
  ...
  <tr>
    ...
    <td bgcolor="#eee"><strong>Purchased Box</strong></td>
