...
<!--*********************************-->
		<div class="span12">
			...
			<h4>Medicine Expired Reports<small class="pull-right">&nbsp;</small></h4>
            <div align="center"><?php echo $msg;?><?php echo $msg1;?>
	  </div>
			<div class="row-fluid" style="background-color:#fff; padding:10px 10px 10px 10px; font-size:14px; text-align:justify; line-height:25px; width:98%;">
            
			<div id="sidebar" class="span12">
<form  action="ph_expired_report.php" name="form" id="form" method="post" enctype="multipart/form-data">
...
if(((strtotime($exp_format_date)-time())/(60 * 60 * 24))<0)
{
