...
window.location="ph_daily_report_print.php?dt="+dt+"&dt1="+dt1;
//window.open("ph_sup_report_print.php?dt="+dt+"&dt1="+dt1,'_blank');
}
</script>
<script>
function opensearchcusrepotdoc(searchval,patient,searchtype){
window.location="ph_daily_report_print.php?searchcustomer="+encodeURIComponent(searchval)+"&patient="+patient+"&searchtype="+searchtype;
//window.open("ph_sup_report_print.php?dt="+dt+"&dt1="+dt1,'_blank');
}
</script>
<script>
function opensearchcusrepotdoc1(pati_id,patient_type,patient_id,referid,bed_no,search_type){
window.location="ph_daily_report_print1.php?pati_id="+pati_id+"&patient_type="+patient_type+"&patient_id="+patient_id+"&referid="+referid+"&bed_no="+bed_no+"&search_type="+search_type;
//window.open("ph_sup_report_print.php?dt="+dt+"&dt1="+dt1,'_blank');
}
</script>
<!-- Header End====================================================================== -->
...
<!--*********************************-->
		<div class="span12">
			...
			<h4>Daily Collection<small class="pull-right">&nbsp;</small></h4>
            <div align="center"><?php echo $msg;?><?php echo $msg1;?>
	  </div>
			<div class="row-fluid" style="background-color:#fff; padding:10px 10px 10px 10px; font-size:14px; text-align:justify; line-height:25px; width:98%;">
            
			<div id="sidebar" class="span12">
<form  action="ph_daily_report.php" name="form" id="form" method="post" enctype="multipart/form-data">
